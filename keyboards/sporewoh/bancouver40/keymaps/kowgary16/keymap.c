...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_ortho_4x10(
    KC_7,      KC_8,    KC_9,  KC_BSLASH,           KC_T,            KC_Y,  KC_U,              KC_I,    KC_O,    KC_P,
    KC_4,      KC_5,    KC_6,  LSFT(KC_8),           KC_G,            KC_H,  KC_J,              KC_K,    KC_L,    KC_SCOLON,
    KC_1,      KC_2,    KC_3,  KC_MINUS,           KC_B,            KC_N,  KC_M,              KC_COMM, KC_DOT,  KC_SLSH,
    KC_0,      KC_DOT,  KC_ENTER, LSFT(KC_EQUAL), LT(2, KC_SPACE), MO(1), LSFT_T(KC_BSPACE), KC_NO,   KC_LALT, KC_ENTER),
  [1] = LAYOUT_ortho_4x10(
